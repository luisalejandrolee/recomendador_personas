...
## threshold on probability to decide on class
#preds_rforest <- ifelse(probs$yes > 0.01, "yes", "no")

# use caret to do both the confusion matrix and print some stats
#print(confusionMatrix(as.factor(predictions), test_y$t_credito_new,
 #                     positive = "yes", mode = "sens_spec"))
